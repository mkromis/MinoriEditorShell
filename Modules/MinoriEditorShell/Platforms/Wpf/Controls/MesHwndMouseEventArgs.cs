...
namespace MinoriEditorShell.Platforms.Wpf.Controls
{
    public class MesHwndMouseEventArgs : EventArgs
    {
        ...
        public MesHwndMouseEventArgs(MesHwndMouseState state)
        {
        ...
        public MesHwndMouseEventArgs(MesHwndMouseState state, int mouseWheelDelta, int mouseHWheelDelta)
            : this(state)
        {
        ...
        public MesHwndMouseEventArgs(MesHwndMouseState state, MouseButton doubleClickButton)
            : this(state)
        {
