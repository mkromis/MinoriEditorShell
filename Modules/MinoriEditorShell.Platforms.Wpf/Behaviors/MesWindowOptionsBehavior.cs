...
namespace MinoriEditorShell.Platforms.Wpf.Behaviors
{
    ...
    //        "ShowMinimizeBox", typeof(Boolean), typeof(MesWindowOptionsBehavior),
    //        new PropertyMetadata(true, OnWindowOptionChanged));
    ...
    //        "ShowMaximizeBox", typeof(Boolean), typeof(MesWindowOptionsBehavior),
    //        new PropertyMetadata(true, OnWindowOptionChanged));
    ...
    //    private static void OnWindowOptionChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) => ((MesWindowOptionsBehavior)d).UpdateWindowStyle();
