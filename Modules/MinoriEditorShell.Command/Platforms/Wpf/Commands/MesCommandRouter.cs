...
{
    [Export(typeof(IMesCommandRouter))]
    public class MesCommandRouter : IMesCommandRouter
    {
        private static readonly Type CommandHandlerInterfaceType = typeof(IMesCommandHandler<>);
        private static readonly Type CommandListHandlerInterfaceType = typeof(ICommandListHandler<>);

        private readonly Dictionary<Type, MesCommandHandlerWrapper> _globalCommandHandlerWrappers;
        private readonly Dictionary<Type, HashSet<Type>> _commandHandlerTypeToCommandDefinitionTypesLookup;
            
        [ImportingConstructor]
        public MesCommandRouter(
        ...
        private Dictionary<Type, MesCommandHandlerWrapper> BuildCommandHandlerWrappers(ICommandHandler[] commandHandlers)
        {
            ...
            Dictionary<Type, MesCommandHandlerWrapper> result = new Dictionary<Type, MesCommandHandlerWrapper>();
