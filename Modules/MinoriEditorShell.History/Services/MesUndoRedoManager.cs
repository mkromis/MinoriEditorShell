...
{
    public class MesUndoRedoManager : MvxNotifyPropertyChanged, IMesUndoRedoManager
    {
        public MvxObservableCollection<IMesUndoableAction> ActionStack { get; } = new MvxObservableCollection<IMesUndoableAction>();

        public IMesUndoableAction CurrentAction => UndoActionCount > 0 ? ActionStack[UndoActionCount - 1] : null;
        ...
        public int UndoActionCount
        {
            ...
            private set
            {
                ...
                RaisePropertyChanged(() => UndoActionCount);
                RaisePropertyChanged(() => RedoActionCount);
        ...
        public void ExecuteAction(IMesUndoableAction action)
        {
        ...
        public void UndoTo(IMesUndoableAction action)
        {
            if (action == null)
        ...
        public void RedoTo(IMesUndoableAction action)
        {
            if (action == null)
                throw new ArgumentNullException(nameof(action));
